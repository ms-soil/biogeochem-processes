...
# ------ Accessing data from database
      Data = read.csv("F:\\5_REDD-ALERT\\Workspace\\Statistics\\2_Controls regulating SOC change\\Time after conversion\\By_Country -decay functions\\Proportional change in SOC2.csv", header = T, sep = ",")
